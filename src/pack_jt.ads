...
package Pack_JT is
   ...
   procedure Unpack_Call(NCall : Unsigned_32; Word : out String; Iv2 : out Integer; Psfx : out String)
     with Pre => NCall <= 2147483647 and then (((Word'Length = 12) and then (Psfx'Length = 4)) or else raise Array_Out_Of_Bounds);
   ...
   procedure Grid2Deg(Grid0 : String; DLong : out Float; DLat : out Float)
     with Pre => Grid0'Length = 6 or else raise Array_Out_Of_Bounds;
